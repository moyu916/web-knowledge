...
<img src="media/web.png" style="zoom: 67%;" />
...
<img src="media/b.png" style="zoom:67%;" />
...
<img src="media/bz.png" style="zoom:67%;" />
...
<img src="media/gx.png" style="zoom:67%;" />
...
> 单标签有：
> <br />   <hr />
> <img src="URL" width=" " target="_blank" />
> <base target="_blank" /> //写一些html统一的东西，减少冗余。在<head>中，用于设置默认。
> <link /> //引入CSS
> ~~~
...
<img src="media/sh.png" style="zoom: 67%;" /> 
...
把所有的连接 都默认添加 target="_blank"
 ...
 <img src="media/base.png" style="zoom:80%;" />
...
<img src="media/zs.png" style="zoom:80%;" />

## 路径(重点、难点)

<img src="media/lj.png" style="zoom:80%;" />
...
### 有序列表 ol （了解）
<img src="media/gold.png" style="zoom:67%;" />
...
<img src="media/mix.png" style="zoom:80%;" />
...
存在即是合理的。  表格的现在还是较为常用的一种标签，但不是用来布局，常见处理、显示表格式
...
<img src="media/tt.png" style="zoom:80%;" />
...
表头单元格一般位于表格的第一行或第一列，其文本加粗居中，如下图所示，即为设置了表头的表格。设置表头非常简单，只需用表头标签&lt;th&gt;</th&gt;替代相应的单元格标签&lt;td&gt;</td&gt;即可。 
 ...
 <img src="media/th.png" style="zoom:67%;" />
...
<img src="media/thead.png" style="zoom:67%;" />
...
<img src="media/bd.png" style="zoom: 67%;" />
...
<img src="media/input.png" style="zoom:67%;" />
...
<img src="media/textarea.png" style="zoom:67%;" />
...
<img src="C:\Users\fc\AppData\Roaming\Typora\typora-user-images\image-20200331224929377.png" alt="image-20200331224929377" style="zoom:67%;" />
